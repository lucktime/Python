...
while (pageIndex < 65):
   ...
   link = 'https://www.mara.gov.au/api/agentsearch?DelimitedStartWithLetterFilter%5BFieldName%5D=DisplayBusiness.Name&DelimitedStartWithLetterFilter%5BLetterString%5D=&DelimitedStartWithLetterFilter%5BLabel%5D=Show+All&DelimitedStartWithLetterFilter%5BIsSelected%5D=true&DelimitedStartWithLetterFilter%5BContainsData%5D=true&Keyword=&Location=shanghai&BusinessName=&IsNoFee=&IsPractitioner=&AgentFamilyName=&AgentGivenName=&AgentName=&AgentMARN=&SortInfo%5BSortField%5D=&SortInfo%5BIsAscending%5D=false&PagingInfo%5BPageIndex%5D=0&PagingInfo%5BPageSize%5D=20'
   print pageIndex
   # input csv file
   csvPageindexfile = file('hrefFile-shanghai.csv', 'a+')
...
#step:(2) ----
    ...
    #break;
# input csv file
       csvfile = file('csvtest-shanghai.csv', 'a+')
